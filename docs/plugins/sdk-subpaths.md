...
<AccordionGroup>
  <Accordion title="Channel subpaths">
    ...
    | `plugin-sdk/channel-echo` | Native streaming echo renderer registry for channel plugins that own a channel id and want pinned echo targets to render live on that channel. |
